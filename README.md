...
[![Build Status](https://travis-ci.org/varavut/elasticsearch-odm.svg?branch=es-2.x)](https://travis-ci.org/varavut/elasticsearch-odm)
[![Dependency Status](https://david-dm.org/varavut/elasticsearch-odm/es-2.x.svg)](https://david-dm.org/varavut/elasticsearch-odm/es-2.x)
[![Dev Dependency Status](https://david-dm.org/varavut/elasticsearch-odm/es-2.x/dev-status.svg)](https://david-dm.org/varavut/elasticsearch-odm/es-2.x#info=devDependencies)
